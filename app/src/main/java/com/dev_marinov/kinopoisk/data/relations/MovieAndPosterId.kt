...
// вспомогательный класс, который связывает таблицы Movie и Posters
// это простые отношения one to one
data class MovieAndPosterId(
    ...
    // не комментируя его @Embedded мы говорим руму что posterEntity это объект наших отношений
    val posterEntity: PosterEntity
)